<?php
    class search extends database {
        ...
        public function aroundMe($location, $type="list", $start=false, $limit=false) {
            ...
            //$query = "SELECT `ref`, `last_name`, `other_names`, `screen_name`, `email`, `mobile_number`, `street`, `city`, `state`, `country`, `account_type`, `latitude`, `longitude`, `about_me`, `image_url`, `average_response_time`, SQRT(((`latitude` - ".$latitude.")*(`latitude` - ".$latitude.")) + ((`longitude` - ".$longitude.")*(`longitude` - ".$longitude."))) AS `total` FROM `users` WHERE `status` = 'ACTIVE' AND `users`.`verified` = 2 AND `user_type` = 1 AND ((`country` LIKE '".$location['code']."' OR `country` LIKE '".$location['country']."') AND (`state` LIKE '".$location['state_code']."' OR `state` LIKE '".$location['state']."')) ORDER BY `is_featured` DESC, `total` ASC".$limitData;

            $query = "SELECT `ref`, `last_name`, `other_names`, `screen_name`, `email`, `mobile_number`, `street`, `city`, `state`, `country`, `account_type`, `latitude`, `longitude`, `about_me`, `image_url`, `average_response_time`, SQRT(((`latitude` - ".$latitude.")*(`latitude` - ".$latitude.")) + ((`longitude` - ".$longitude.")*(`longitude` - ".$longitude."))) AS `total` FROM `users` WHERE `status` = 'ACTIVE' AND `users`.`verified` = 2 AND `user_type` = 1 ORDER BY `is_featured` DESC, `total` ASC".$limitData;
        ...
        public function keywordSearch($location, $val, $type="list", $start=false, $limit=false) {
            ...
            //$query = "SELECT `users`.`ref`, `users`.`last_name`, `users`.`other_names`, `users`.`screen_name`, `users`.`email`, `users`.`mobile_number`, `users`.`street`, `users`.`city`, `users`.`state`, `users`.`country`, `users`.`account_type`, `users`.`latitude`, `users`.`longitude`, `users`.`about_me`, `users`.`image_url`, `users`.`average_response_time`, SQRT(((`users`.`latitude` - ".$latitude.")*(`users`.`latitude` - ".$latitude.")) + ((`users`.`longitude` - ".$longitude.")*(`users`.`longitude` - ".$longitude."))) AS `total` FROM `users`,`usersCategory` WHERE `users`.`status` = 'ACTIVE' AND `users`.`verified` = 2 AND `users`.`ref` = `usersCategory`.`user_id` AND `users`.`user_type` = 1 AND (`users`.`last_name` LIKE :s OR `users`.`other_names` LIKE :s OR `users`.`screen_name` LIKE :s OR `usersCategory`.`category_id` IN (SELECT `category`.`ref` FROM `category` WHERE `category`.`category_title` LIKE :s)) AND ((`country` LIKE '".$location['code']."' OR `country` LIKE '".$location['country']."') AND (`state` LIKE '".$location['state_code']."' OR `state` LIKE '".$location['state']."')) GROUP BY `users`.`ref` ORDER BY `users`.`is_featured` DESC, `total` ASC".$limitData;
            
            $query = "SELECT `users`.`ref`, `users`.`last_name`, `users`.`other_names`, `users`.`screen_name`, `users`.`email`, `users`.`mobile_number`, `users`.`street`, `users`.`city`, `users`.`state`, `users`.`country`, `users`.`account_type`, `users`.`latitude`, `users`.`longitude`, `users`.`about_me`, `users`.`image_url`, `users`.`average_response_time`, SQRT(((`users`.`latitude` - ".$latitude.")*(`users`.`latitude` - ".$latitude.")) + ((`users`.`longitude` - ".$longitude.")*(`users`.`longitude` - ".$longitude."))) AS `total` FROM `users`,`usersCategory` WHERE `users`.`status` = 'ACTIVE' AND `users`.`verified` = 2 AND `users`.`ref` = `usersCategory`.`user_id` AND `users`.`user_type` = 1 AND (`users`.`last_name` LIKE :s OR `users`.`other_names` LIKE :s OR `users`.`screen_name` LIKE :s OR `usersCategory`.`category_id` IN (SELECT `category`.`ref` FROM `category` WHERE `category`.`category_title` LIKE :s)) GROUP BY `users`.`ref` ORDER BY `users`.`is_featured` DESC, `total` ASC".$limitData;
